...
public class POSTHttpUrlConnectionActivity extends AppCompatActivity {

    private String tag = this.getClass().getSimpleName();

    private String HOSTNAME = "reqres.in";
    private String strUrl = "https://reqres.in/api/users";
    ...
    private void postSSL() {
        try {
            ...
            InputStream inputStream = new BufferedInputStream(getAssets().open("reqres.crt"));
            ...
            writer.write("{\"name\": \"morpheuss\",\"job\": \"leader\"}");
            writer.flush();
            writer.close();
            os.close();
